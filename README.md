# KleiderPilot 0.10.1 – Geräte-Synchronisierung ohne Login
...
Das SQL ist nicht destruktiv: die Tabellen und der Storage-Bucket aus 0.10 bleiben bestehen. 0.10.1 nutzt neue, gemeinsame Workspace-Tabellen und einen neuen privaten Bilder-Bucket.
...
Der Service Worker arbeitet network-first und verwendet einen neuen Cache-Namen `kleiderpilot-0.10.1-shell-v1`, damit Updates auf PC/iPad/iPhone zuverlässiger geladen werden.
